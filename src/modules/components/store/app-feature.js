export const FeatureTypes = {
  ...
  FunctionalLocation: "Api-FunctionalLocation",
};
  ...
  features.forEach((item) => {
    switch (item.id) {
      ...
      case FeatureTypes.WorkInProcess:
        ...
        break;
      case FeatureTypes.Dispatch:
        item["icon"] = "checkouttools-icon";
        item["url"] = "dispatch/list";
        break;
      case FeatureTypes.FunctionalLocation:
        item["icon"] = "locations-icon";
        item["url"] = "functionallocationreport";
        break;
      default:
        break;
    }
